...
$featurearray = array("Efficacy – protection against symptomatic infection " => array("50%","70%","90%"),"Efficacy – protection against severe illness, hospitalization, death" => array("50%","70%","90%"),"Efficacy - protection against future potential variants" => array("Protects against future variants
","May require booster against future variants
"),"Protection duration

" => array("6 months","1 year","2 years","Lifetime"),"Manufacturer" => array("Pfizer","Moderna","Johnson & Johnson"),"Incentive offered" => array("Paid Day Off Work","Unpaid Day Off Work","$10","$100"));
